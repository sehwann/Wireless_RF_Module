...
# 2 "<built-in>" 2
# 1 "Si4463/si446x_api_lib.c" 2
# 12 "Si4463/si446x_api_lib.c"
...
void si446x_set_property( U8 GROUP, U8 NUM_PROPS, U8 START_PROP, ... )
{
    ...
    *argList = __va_start();
    ...
    while(NUM_PROPS--)
    {
        Pro2Cmd[cmdIndex] = (*(U8 *)__va_arg((*(U8 **)argList), (U8)0));
        cmdIndex++;
    }
                   ;
...
{
  radio_comm_WriteData( 0x66, 0, numBytes, pTxData );
}
...
void si446x_read_rx_fifo(U8 numBytes, U8* pRxData)
{
  radio_comm_ReadData( 0x77, 0, numBytes, pRxData );
}
# 348 "Si4463/si446x_api_lib.c"
void si446x_get_property(U8 GROUP, U8 NUM_PROPS, U8 START_PROP)
{
    Pro2Cmd[0] = 0x12;
    Pro2Cmd[1] = GROUP;
